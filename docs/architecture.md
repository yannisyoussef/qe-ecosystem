...
| Scope failure | A failure of a non-test node of the runner hierarchy (class, suite, file, module) | Recorded as its own event with the scope's path; it fails the execution without changing any attempt's verdict (ADR-0005) |
