...
| Maven artifact | `qe-<product>-<module>` | `qe-report-protocol`, `qe-report-client`, `qe-report-junit5`, `qe-report-karate`, `qe-bom` |
| Java package | `io.github.yannisyoussef.qe.<product>.<module>` | `io.github.yannisyoussef.qe.report.junit5` |
...
| Adapter | `qe-report-<runner>` | one artifact per runner, never per tool |
...
- Before 1.0 a minor version may break, and the CHANGELOG says so. 1.0 of an
  adapter or SDK requires 1.0 of the protocol.
